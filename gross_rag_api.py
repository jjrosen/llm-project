...
dense_index = pc.Index("gross-project")  # Use YOUR Pinecone index name
    ...
    if conversation_id not in conversations:
        conversations[conversation_id] = [
            ...
            * Verbiage++, a content management system.
             if you don't know what the user is talking about, don't assume ask more questions to figure it out"""}
        ]
